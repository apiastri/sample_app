...
describe User do
  ...
  it "should require a name" do
    no_name_attribute = User.new(@attr.merge( :name => ""))
    no_name_attribute.should_not be_valid
  end

  it "should require an email" do
    no_email_attribute = User.new(@attr.merge( :email => ""))
    no_email_attribute.should_not be_valid
  end  
  ...
  describe "password validations" do  
    ...
    it "should require a matching password confirmation" do
      User.create(@attr.merge( :password_confirmation => "Invalid")).
         should_not be_valid
     end
